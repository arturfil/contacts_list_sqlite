...
import com.arturofilio.contact_app_sqlite.MainActivity;
        ...
        if(property.contains("@")){
            ...
            holder.leftIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String body = "body"
                    String uriTxt = "malito: + Uri.encode(email) + "?subject=" + Uri.encode(subject)
                    + "&body" + Uri.encode(body);
                    Uri uri = Uri.parse(uriText);

                    email Intent.setData(uri);
                    mContext.startActiviy(emailInten);
                ...
                public void onClick(View v) {
                    if(((MainActivity)mContext).checkPermission(Init.PHONE_PERMISSIONS)){
                        ...
                        Intent callIntent = new Intent(Intent.ACTION_CALL,
                                Uri.fromParts("tel", property, null));
