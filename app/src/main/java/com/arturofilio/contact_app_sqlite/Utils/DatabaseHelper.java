...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    /**
     * Insert a new contact on to the database
     * @param contact
     * @return
     */
    ...
    /**
     * Retieve all contacts form the database
     * @return
     */
    ...
    /**
     * Retrieve the contact unique id form thje database using @param
      * @param contact
     * @return
     */
