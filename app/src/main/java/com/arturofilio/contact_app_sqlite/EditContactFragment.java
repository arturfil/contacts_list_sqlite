...
public class EditContactFragment extends Fragment implements ChangePhotoDialog.OnPhotoReceiveListener {
    ...
    private void init() {
        ...
        UniversalImageLoader.setImage(mContact.getProfileImage(), mProfileImage,null, "");
